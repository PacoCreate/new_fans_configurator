const ButtonSelectorType = (props) => {
  ...
  function handleButton(ev) {
    ...
    if (props.numberStep === "2") {
      //updateMaterial guarda en un estado el motor escogido para más tarde hacer el filtro con las apas. Estoy segura de que esto es prescindible con el estado donde guardo el motor. Solo lo renderizo en este paso porque en el tercer paso me petaría
